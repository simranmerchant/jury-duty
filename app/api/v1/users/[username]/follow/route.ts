...
// POST /api/v1/users/[username]/follow — follow or request to follow (param is user ID)
...
// DELETE /api/v1/users/[username]/follow — unfollow or cancel request (param is user ID)
