...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    body: "predictions aren't just predictions — they're conversations.",
    bullets: [
      { text: "react or comment on any prediction" },
      { text: "make a prediction private — only invited people see it" },
      { text: "go anonymous — your name stays hidden from the pool" },
    ],
  },
  {
    icon: <IconBell />,
    ...
    body: "add jury duty to your home screen and enable notifications so you never miss a result.",
    bullets: [
