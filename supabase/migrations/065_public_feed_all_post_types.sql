-- Migration 065: extend public-feed visibility to poll_posts and explore_bet_posts.
-- Regular posts already show from all public accounts (migration 059).
-- This update applies the same rule to the other two post types.
