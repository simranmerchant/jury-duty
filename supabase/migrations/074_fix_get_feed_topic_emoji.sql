-- Migration 074: remove reference to topics.emoji (dropped in 073) from get_feed.
-- The emoji column no longer exists; the topic subquery must only select id and name.
