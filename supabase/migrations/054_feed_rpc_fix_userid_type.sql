-- Fix get_feed: user IDs are Privy DIDs (text), not uuid.
-- Drop the uuid-param version created by 053, then recreate with text.
DROP FUNCTION IF EXISTS get_feed(uuid, timestamptz, boolean, boolean);
